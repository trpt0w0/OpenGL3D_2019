...
*
*	描画が、VertexAttribPointer(), ResetVertexAttribPointer()を呼び出す前に
*	この関数を実行してVAOをバインドする必要がある
*
*	@sa Unbind(), VertexAttribPointer()
*/
...
*
*	@sa Bind(),VertexAtribPointer(), ResetVertexAttribPointer()
*/
...
*	
*	Bind()してから, Unbind()するまでの間で呼び出すこと
*
