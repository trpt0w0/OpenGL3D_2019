...
namespace Mesh {
	...
	*					(GL_UNSIGNED_BYTE, GL_UNSIGNED_SHORT, GL_UNSIGNED_INT のいずれか).
	*	@param iOffset	IBO内のインデックスデータの開始位置
	*	@param vOffset	VBO内のの頂点データの開始位置
	*
	...
	*/
	...
	bool Buffer::SetAttribute(
		Primitive* prim, int index, const json11::Json& accessor,
